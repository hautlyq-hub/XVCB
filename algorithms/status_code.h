...
inline std::string statusCodeToString(StatusCode code) {
    switch (code) {
        ...
        case StatusCode::READ_IMAGE_ERROR: return "READ_IMAGE_ERROR";
        case StatusCode::PROCESS_IMAGE_ERROR: return "PROCESS_IMAGE_ERROR";
        case StatusCode::EMPTY_CABLE_ERROR: return "EMPTY_CABLE_ERROR";
        case StatusCode::ANORMAL_CABLE_ERROR: return "ANORMAL_CABLE_ERROR";
        case StatusCode::ALGORITHM_ERROR: return "ALGORITHM_ERROR";
        case StatusCode::DENOISE_ERROR: return "DENOISE_ERROR";
