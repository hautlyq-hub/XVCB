...
bool XDSkin9GridImage::splitRect(const QRect &rcSrc, QPoint ptTopLeft, QRect *parrayRect, int nArrayCount)
{
...
bool XDSkin9GridImage::setImage(const QImage &image, QPoint ptTopLeft)
{
    clear();
    //
    m_img = image;
...
void XDSkin9GridImage::drawBorder(QPainter *p, QRect rc) const
{
    QRect arrayDest[9];
    //
...
XDShadowWidget::XDShadowWidget(int shadowSize, bool canResize, QWidget *parent)
    : m_shadowSize(shadowSize)
    , QWidget(parent)
    , m_shadow(new XDSkin9GridImage())
{
...
void XDShadowWidget::paintEvent(QPaintEvent *e)
{
